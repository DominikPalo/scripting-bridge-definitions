...
@class KeynoteApplication, KeynoteDocument, KeynoteWindow, KeynoteTheme, KeynoteRichText, KeynoteCharacter, KeynoteParagraph, KeynoteWord, KeynotePlaceholderText, KeynoteIWorkContainer, KeynoteSlide, KeynoteMasterSlide, KeynoteIWorkItem, KeynoteAudioClip, KeynoteShape, KeynoteChart, KeynoteImage, KeynoteGroup, KeynoteLine, KeynoteMovie, KeynoteTable, KeynoteTextItem, KeynoteRange, KeynoteCell, KeynoteRow, KeynoteColumn;
...
- (SBElementArray<KeynotePlaceholderText *> *) placeholderTexts;
...
@interface KeynotePlaceholderText : KeynoteRichText
